  ...
  return (
    <section id="why-choose" aria-labelledby="why-title" className="relative bg-gradient-to-b from-white to-blue-50/20">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-16 lg:py-24">
        ...
        {/* Equal size columns with enhanced animations */}
        <div className="grid grid-cols-1 lg:grid-cols-2 items-stretch auto-rows-fr gap-10 lg:gap-14">
          {/* Left: Enhanced video with hover effects - CENTERED VERTICALLY */}
          <div className="why-content">
            <div className="group relative rounded-2xl overflow-hidden ring-1 ring-gray-200 bg-gray-50 h-full shadow-lg transition-all duration-700 cubic-bezier(0.4, 0, 0.2, 1) hover:-translate-y-2 hover:scale-[1.02] hover:shadow-2xl hover:shadow-blue-600/20 hover:ring-blue-300 flex items-center justify-center">
              <div className="absolute inset-0 bg-gradient-to-br from-blue-500/10 to-blue-600/20 opacity-0 group-hover:opacity-100 transition-opacity duration-500 z-10"></div>
                ...
                <IconContext.Provider value={{ className: "h-6 w-6 text-blue-600 relative z-10" }}>
                  {features.map((f, i) => {
                    ...
                    return (
                      <li
                        key={f.title}
                        className="group flex items-start gap-4 rounded-xl p-3 -m-3 transition-all duration-500 cubic-bezier(0.4, 0, 0.2, 1) hover:bg-blue-50/80 hover:-translate-y-1 hover:shadow-lg hover:shadow-blue-600/10 cursor-pointer"
                        style={{ animationDelay: `${i * 100}ms` }}
                      >
                        <span
                          className="feature-icon-glow inline-flex h-11 w-11 flex-none items-center justify-center rounded-xl bg-blue-50 ring-1 ring-blue-100 transition-all duration-500 cubic-bezier(0.4, 0, 0.2, 1) group-hover:bg-blue-100 group-hover:ring-blue-200 group-hover:scale-110 group-hover:-translate-y-1 group-hover:shadow-lg"
                          aria-hidden="true"
                        >
            ...
            <div className="pt-6">
                <Link to="why-choose-us">
                    ...
                    >
                        ...
                        <FaArrowRight className="h-5 w-5 transition-all duration-400 cubic-bezier(0.4, 0, 0.2, 1) group-hover:translate-x-1 group-hover:scale-110" />
                    </button>
                </Link>
            </div>
          </div>

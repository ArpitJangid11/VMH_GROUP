  ...
  return (
    ...
    >
      {cardsToShow.map((card) => (
        ...
        >
          {/* Icon */}
          <div className="w-16 h-16 sm:w-20 sm:h-20 bg-blue-600 group-hover:bg-white rounded-full 
          ...
          {/* Title */}
          <h3 className="text-lg sm:text-xl font-semibold mb-4 sm:mb-6 text-gray-800 group-hover:text-white
          ...
          <Link to={card.link} className="block">
            <button
              className="w-full sm:w-auto inline-flex items-center justify-center rounded-full px-5 py-3 text-sm sm:text-base font-semibold 
                         ...
                         shadow-md"
            >
              <span className="transition-all duration-400 ease-in-out group-hover:translate-x-1">
                {card.buttonText}
              </span>
              <svg
